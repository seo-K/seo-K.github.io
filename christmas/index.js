...
const modalOpen =(currentIndex) => {
  ...
  let modalCardText = document.createElement("figcaption");
  console.log(modalMessageList[currentIndex].message)
  modalCardText.innerText = modalMessageList[currentIndex].message; 
